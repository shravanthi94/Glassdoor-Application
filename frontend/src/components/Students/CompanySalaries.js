                    ...
                    <div className="overview-all">
                        ...
                        <div className="profile-row-one">
                            ...
                            <table className="profile-row-one-table">
                                ...
                                <td className="profile-titles-selected"><div className="profile-counts">{this.props.company.overview.numberOfSalaries}</div><div className="profile-title" onClick={() => this.redirectHandler("salaries")}>Salaries&emsp;</div></td>
