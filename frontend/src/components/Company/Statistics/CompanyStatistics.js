...
const CompanyStatistics = ({
  ...
  let lastYearJobs = 0;
  if (companyjobs) {
    curYearJobs = companyjobs.filter((job) =>
      String(job.date).includes(String(curYear)),
    );
    lastYearJobs = companyjobs.filter((job) =>
      String(job.date).includes(String(curYear - 1)),
    );
  ...
  if (companyjob) {
    applicantsHired = companyjob.applicants.filter(
      (applicant) => applicant.applicantStatus === 'hired',
    ).length;
    console.log('company applicants', applicantsHired);
    applicantsRejected = companyjob.applicants.filter(
      (applicant) => applicant.applicantStatus === 'rejected',
    ).length;
  ...
  if (companyjob) {
    AmericanIndianorAlaskaNative = companyjob.applicants.filter(
      (applicant) =>
        applicant.student.demographics.ethnicity ===
        'American Indian or Alaska Native',
    ).length;
    console.log(
      'company applicants by AmericanIndian...',
      AmericanIndianorAlaskaNative,
    );
    Asian = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.ethnicity === 'Asian',
    ).length;
    console.log('company applicants by Asian...', Asian);
    BlackorAfricanAmerican = companyjob.applicants.filter(
      (applicant) =>
        applicant.student.demographics.ethnicity ===
        'Black or African American',
    ).length;
    console.log(
      'company applicants by BlackAfrican...',
      BlackorAfricanAmerican,
    );
    NativeHawaiianorOtherPacificIslander = companyjob.applicants.filter(
      (applicant) =>
        applicant.student.demographics.ethnicity ===
        'Native Hawaiian or Other Pacific Islander',
    ).length;
    console.log(
      'company applicants by NativeHawaiian...',
      NativeHawaiianorOtherPacificIslander,
    );
    White = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.ethnicity === 'White',
    ).length;
    console.log('company applicants by White...', White);
    Male = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.gender === 'Male',
    ).length;
    console.log('company applicants by White...', Male);
    Female = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.gender === 'Female',
    ).length;
    console.log('company applicants by White...', Female);
    Disabled = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.disability === 'Yes',
    ).length;
    console.log('company applicants by White...', Disabled);
    NonDisabled = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.disability === 'No',
    ).length;
    console.log('company applicants by White...', NonDisabled);
    Veteran = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.veteran === 'Yes',
    ).length;
    console.log('company applicants by White...', Veteran);
    NonVeteran = companyjob.applicants.filter(
      (applicant) => applicant.student.demographics.veteran === 'No',
    ).length;
    ...
    <Fragment>
      ...
      <div className='contentholder-Jobs-company mt-3'>
        <div className='contentholder-Jobs-company-sub'>
          <div className='h4' style={{ color: '#1861BF', marginLeft: '43%' }}>
            Current Year Jobs: {companyjobs ? curYearJobs.length : '0'}
          </div>
        </div>
      </div>
      ...
      <div className='contentholder-Jobs-company mt-1'>
        <div className='company-cards-3columns'>
          {companyjobs ? (
            curYearJobs.slice(indexOfFirst, indexOfLast).map((job) => (
              <Fragment>
                <div
                  className='company-cards-column-one'
                  style={{ width: '29rem', border: '1px solid #888' }}
                >
                              ...
                              <div class='modal-content'>
                                <div class='modal-header'>
                                  ...
                                  >
                                    ...
                                    {companyjob &&
                                    companyjob.applicants.length > 0 ? (
                                      companyjob.title
                                    ) : (
                                      <p style={{ color: 'red' }}>
                                        {' '}
                                    ...
                                    <Fragment>
                                      <div style={{ display: 'flex' }}>
                                        <Chart
                                          ...
                                          options={{
                                            title:
                                              'Applicants by Application Status',
                                          }}
                                        ...
                                        <Chart
                                          ...
                                          data={[
                                            [
                                              'Applicants',
                                              'applicants categorized by ethnicity',
                                            ],
                                            [
                                              'American Indian or Alaska Native',
                                              AmericanIndianorAlaskaNative,
                                        ...
                                        <Chart
                                          ...
                                          data={[
                                            [
                                              'Applicants',
                                              'applicants categorized by Gender',
                                            ],
                                            ['Male', Male],
                                            ['Female', Female],
                                          ]}
                                      ...
                                      <div style={{ display: 'flex' }}>
                                        <Chart
                                          ...
                                          data={[
                                            [
                                              'Applicants',
                                              'Applicants categorized by Disability',
                                            ],
                                            ['Disabled', Disabled],
                                        ...
                                        <Chart
                                          ...
                                          data={[
                                            [
                                              'Applicants',
                                              'Applicants categorized by Veteran status',
                                            ],
                                            ['Veteran', Veteran],
      ...
      <div className='contentholder-Jobs-company mt-3'>
        <div className='contentholder-Jobs-company-sub'>
          <div className='h4' style={{ color: '#1861BF', marginLeft: '43%' }}>
            Last Year Jobs: {companyjobs ? lastYearJobs.length : '0'}
          </div>
        </div>
      </div>
      <div className='contentholder-Jobs-company mt-1'>
        <div className='company-cards-3columns'>
          {companyjobs ? (
            lastYearJobs.slice(indexOfFirst, indexOfLast).map((job) => (
              <Fragment>
                <div
                  className='company-cards-column-one'
                  style={{ width: '29rem', border: '1px solid #888' }}
                    ...
                    <tr>
                      <td>
                        <table>
                          ...
                          <tr>
                            <td>
                              <h6 className='card-title joblisting-title-company'>
                                {job.title}
                              </h6>
                            </td>
                          </tr>
